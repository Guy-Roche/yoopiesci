                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-3 float-left">
                                    <div class="row">
                                        <div class="wt-userprofile">
                                            <figure>
                                                <img src="{{ asset('web/images/profile/img-01.jpg') }}" alt="img description">
                                    ...
                                    <div class="wt-clientfeedback">
                                        ...
                                        <div class="wt-userlistinghold wt-userlistingsingle wt-bgcolor">
                                            <figure class="wt-userlistingimg">
                                                <img src="{{ asset('web/images/client/img-01.jpg') }}" alt="image description">
                                            </figure>
                                        ...
                                        <div class="wt-userlistinghold wt-userlistingsingle">
                                            <figure class="wt-userlistingimg">
                                                <img src="{{ asset('web/images/client/img-02.jpg') }}" alt="image description">
                                            </figure>
                                            <div class="wt-userlistingcontent">
                                                <div class="wt-contenthead">
                                                    <div class="wt-title">
                                        ...
                                        <div class="wt-userlistinghold wt-userlistingsingle wt-bgcolor">
                                            <figure class="wt-userlistingimg">
                                                <img src="{{ asset('web/images/client/img-03.jpg') }}" alt="image description">
                                            </figure>
                                            <div class="wt-userlistingcontent">
                                                <div class="wt-contenthead">
                                                    <div class="wt-title">
                                    ...
                                    <div class="wt-craftedprojects">
                                        ...
                                        <div class="wt-projects">
                                            <div class="wt-project">
                                                <figure>
                                                    <img src="{{ asset('web/images/projects/img-01.jpg') }}" alt="img description">
                                                </figure>
                                            ...
                                            <div class="wt-project">
                                                <figure>
                                                    <img src="{{ asset('web/images/projects/img-02.jpg') }}" alt="img description">
                                                </figure>
                                                <div class="wt-projectcontent">
                                                    <h3>Videohive</h3>
                                            ...
                                            <div class="wt-project">
                                                <figure>
                                                    <img src="{{ asset('web/images/projects/img-03.jpg') }}" alt="img description">
                                                </figure>
                                                <div class="wt-projectcontent">
                                                    <h3>Codecanyon</h3>
                                            ...
                                            <div class="wt-project">
                                                <figure>
                                                    <img src="{{ asset('web/images/projects/img-04.jpg') }}" alt="img description">
                                                </figure>
                                                <div class="wt-projectcontent">
                                                    <h3>Graphicriver</h3>
                                            ...
                                            <div class="wt-project">
                                                <figure>
                                                    <img src="{{ asset('web/images/projects/img-05.jpg') }}" alt="img description">
                                                </figure>
                                                <div class="wt-projectcontent">
                                                    <h3>Photodune</h3>
                                            ...
                                            <div class="wt-project">
                                                <figure>
                                                    <img src="{{ asset('web/images/projects/img-06.jpg') }}" alt="img description">
                                                </figure>
                                                <div class="wt-projectcontent">
                                                    <h3>Audiojungle</h3>
                                    ...
                                    <div class="wt-widget wt-widgetarticlesholder wt-articlesuser">
                                        ...
                                        <div class="wt-widgetcontent">
                                            <div class="wt-particlehold">
                                                <figure>
                                                    <img src="{{ asset('web/images/thumbnail/img-07.jpg') }}" alt="image description">
                                                </figure>
                                            ...
                                            <div class="wt-particlehold">
                                                <figure>
                                                    <img src="{{ asset('web/images/thumbnail/img-08.jpg') }}" alt="image description">
                                                </figure>
                                                <div class="wt-particlecontent">
                                            ...
                                            <div class="wt-particlehold">
                                                <figure>
                                                    <img src="{{ asset('web/images/thumbnail/img-09.jpg') }}" alt="image description">
                                                </figure>
                                                <div class="wt-particlecontent">
                                            ...
                                            <div class="wt-particlehold">
                                                <figure>
                                                    <img src="{{ asset('web/images/thumbnail/img-10.jpg') }}" alt="image description">
                                                </figure>
                                                <div class="wt-particlecontent">
                                    ...
                                    <div class="wt-proposalsr">
                                        <div class="tg-authorcodescan tg-authorcodescanvtwo">
                                            <figure class="tg-qrcodeimg">
                                                <img src="{{ asset('web/images/qrcode.png') }}" alt="img description">
                                            </figure>
