...
<div class="wt-categoriesslider-holder wt-haslayout">
    ...
    <div id="wt-categoriesslider" class="wt-categoriesslider owl-carousel">
        <div class="wt-categoryslidercontent item">
            <figure><img src="{{ asset('web/images/categories/slider/img-01.png') }}" alt="image description"></figure>
        ...
        <div class="wt-categoryslidercontent item">
            <figure><img src="{{ asset('web/images/categories/slider/img-02.png') }}" alt="image description"></figure>
            <div class="wt-cattitle">
        ...
        <div class="wt-categoryslidercontent item">
            <figure><img src="{{ asset('web/images/categories/slider/img-03.png') }}" alt="image description"></figure>
            <div class="wt-cattitle">
        ...
        <div class="wt-categoryslidercontent item">
            <figure><img src="{{ asset('web/images/categories/slider/img-04.png') }}" alt="image description"></figure>
            <div class="wt-cattitle">
        ...
        <div class="wt-categoryslidercontent item">
            <figure><img src="{{ asset('web/images/categories/slider/img-05.png') }}" alt="image description"></figure>
            <div class="wt-cattitle">
                                            ...
                                            <fieldset>
                                                <div class="wt-checkboxholder wt-verticalscrollbar">
                                                    <span class="wt-checkbox">
                                                        ...
                                                        <label for="wt-description"> <img src="{{ asset('web/images/flag/img-01.png') }}" alt="img description"> Australia</label>
                                                    </span>
                                                    <span class="wt-checkbox">
                                                        <input id="us" type="checkbox" name="description" value="company">
                                                        <label for="us"> <img src="{{ asset('web/images/flag/img-02.png') }}" alt="img description"> United States</label>
                                                    </span>
                                                    <span class="wt-checkbox">
                                                        <input id="canada" type="checkbox" name="description" value="company">
                                                        <label for="canada"> <img src="{{ asset('web/images/flag/img-03.png') }}" alt="img description"> Canada</label>
                                                    </span>
                                                    <span class="wt-checkbox">
                                                        <input id="england" type="checkbox" name="description" value="company">
                                                        <label for="england"> <img src="{{ asset('web/images/flag/img-04.png') }}" alt="img description"> England</label>
                                                    </span>
                                                    <span class="wt-checkbox">
                                                        <input id="emirates" type="checkbox" name="description" value="company">
                                                        <label for="emirates"> <img src="{{ asset('web/images/flag/img-05.png') }}" alt="img description"> United Emirates</label>
                                                    </span>
                                                    <span class="wt-checkbox">
                                                        <input id="wt-description1" type="checkbox" name="description" value="company">
                                                        <label for="wt-description1"> <img src="{{ asset('web/images/flag/img-01.png') }}" alt="img description"> Australia</label>
                                                    </span>
                                                    <span class="wt-checkbox">
                                                        <input id="us1" type="checkbox" name="description" value="company">
                                                        <label for="us1"> <img src="{{ asset('web/images/flag/img-02.png') }}" alt="img description"> United States</label>
                                                    </span>
                                                </div>
                                            </fieldset>
                                        </form>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 col-xl-8 float-left">
                            <div class="wt-userlistingholder wt-userlisting wt-haslayout">
                                ...
                                <div class="wt-userlistinghold wt-featured">
                                    <span class="wt-featuredtag"><img src="{{ asset('web/images/featured.png') }}" alt="img description" data-tipso="Plus Member" class="template-content tipso_style"></span>
                                    <figure class="wt-userlistingimg">
                                        <img src="{{ asset('web/images/user/userlisting/img-01.jpg') }}" alt="image description">
                                    </figure>
                                    <div class="wt-userlistingcontent">
                                        <div class="wt-contenthead">
                                            ...
                                            <ul class="wt-userlisting-breadcrumb">
                                                ...
                                                <li><span><img src="{{ asset('web/images/flag/img-02.png') }}" alt="img description">  United States</span></li>
                                ...
                                <div class="wt-userlistinghold wt-featured">
                                    ...
                                    <figure class="wt-userlistingimg">
                                        <img src="{{ asset('web/images/user/userlisting/img-02.jpg') }}" alt="image description">
                                    </figure>
                                    <div class="wt-userlistingcontent">
                                        <div class="wt-contenthead">
                                            <div class="wt-title">
                                            ...
                                            <ul class="wt-userlisting-breadcrumb">
                                                <li><span><i class="far fa-money-bill-alt"></i> $44.00 / hr</span></li>
                                                <li><span><img src="{{ asset('web/images/flag/img-05.png') }}" alt="img description">  United Emirates</span></li>
                                ...
                                <div class="wt-userlistinghold wt-featured">
                                    ...
                                    <figure class="wt-userlistingimg">
                                        <img src="{{ asset('web/images/user/userlisting/img-03.jpg') }}" alt="image description">
                                    </figure>
                                    <div class="wt-userlistingcontent">
                                        <div class="wt-contenthead">
                                            <div class="wt-title">
                                            ...
                                            <ul class="wt-userlisting-breadcrumb">
                                                <li><span><i class="far fa-money-bill-alt"></i> $44.00 / hr</span></li>
                                                <li><span><img src="{{ asset('web/images/flag/img-01.png') }}" alt="img description">  Australia</span></li>
                                                <li><a href="javascript:void(0);" class="wt-clicksave"><i class="fa fa-heart"></i> Save</a></li>
                                            </ul>
                                        </div>
                                        <div class="wt-rightarea">
                                ...
                                <div class="wt-userlistinghold">
                                    ...
                                    <div class="wt-userlistingcontent">
                                        <div class="wt-contenthead">
                                            ...
                                            <ul class="wt-userlisting-breadcrumb">
                                                <li><span><i class="far fa-money-bill-alt"></i> $44.00 / hr</span></li>
                                                <li><span><img src="{{ asset('web/images/flag/img-04.png') }}" alt="img description">  England</span></li>
                                                <li><a href="javascript:void(0);" class="wt-clicksave"><i class="fa fa-heart"></i> Save</a></li>
                                            </ul>
                                        </div>
                                        <div class="wt-rightarea">
                                ...
                                <div class="wt-userlistinghold">
                                    <figure class="wt-userlistingimg">
                                        <img src="{{ asset('web/images/user/userlisting/img-04.jpg') }}" alt="image description">
                                    </figure>
                                    <div class="wt-userlistingcontent">
                                        <div class="wt-contenthead">
                                            <div class="wt-title">
                                            ...
                                            <ul class="wt-userlisting-breadcrumb">
                                                <li><span><i class="far fa-money-bill-alt"></i> $44.00 / hr</span></li>
                                                <li><span><img src="{{ asset('web/images/flag/img-03.png') }}" alt="img description">  Canada</span></li>
                                                <li><a href="javascript:void(0);"><i class="fa fa-heart"></i> Click to Save</a></li>
                                            </ul>
                                        </div>
                                        <div class="wt-rightarea">
                                ...
                                <div class="wt-userlistinghold">
                                    <figure class="wt-userlistingimg">
                                        <img src="{{ asset('web/images/user/userlisting/img-05.jpg') }}" alt="image description">
                                    </figure>
                                    <div class="wt-userlistingcontent">
                                        <div class="wt-contenthead">
                                            <div class="wt-title">
                                ...
                                <div class="wt-userlistinghold">
                                    <figure class="wt-userlistingimg">
                                        <img src="{{ asset('web/images/user/userlisting/img-06.jpg') }}" alt="image description">
                                    </figure>
                                    <div class="wt-userlistingcontent">
                                        <div class="wt-contenthead">
                                            <div class="wt-title">
