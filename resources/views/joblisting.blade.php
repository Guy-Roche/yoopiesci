								...
								<div id="wt-twocolumns" class="wt-twocolumns wt-haslayout">
									...
									<div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 col-xl-8 float-left">
										<div class="wt-userlistingholder wt-haslayout">
												...
												<div class="wt-userlistingcontent">
													...
													<div class="wt-viewjobholder">
														<ul>
															...
															<li><span><em><img src="{{ asset('web/images/flag/img-04.png') }}" alt="img description"></em>England</span></li>
											...
											<div class="wt-userlistinghold wt-featured wt-userlistingholdvtwo">
												<span class="wt-featuredtag wt-featuredtagcolor1"><img src="{{ asset('web/images/featured.png') }}" alt="img description" data-tipso="Plus Member" class="template-content tipso_style"></span>
												<div class="wt-userlistingcontent">
													<div class="wt-contenthead">
														<div class="wt-title">
													...
													<div class="wt-viewjobholder">
														<ul>
															<li><span><i class="fa fa-dollar-sign wt-viewjobdollar"></i>Professional</span></li>
															<li><span><em><img src="{{ asset('web/images/flag/img-02.png') }}" alt="img description"></em>United States</span></li>
											...
											<div class="wt-userlistinghold wt-featured wt-userlistingholdvtwo">
												<span class="wt-featuredtag wt-featuredtagcolor2"><img src="{{ asset('web/images/featured.png') }}" alt="img description" data-tipso="Plus Member" class="template-content tipso_style"></span>
												<div class="wt-userlistingcontent">
													<div class="wt-contenthead">
														<div class="wt-title">
													...
													<div class="wt-viewjobholder">
														<ul>
															<li><span><i class="fa fa-dollar-sign wt-viewjobdollar"></i>Professional</span></li>
															<li><span><em><img src="{{ asset('web/images/flag/img-05.png') }}" alt="img description"></em>United Emirates</span></li>
															<li><span><i class="far fa-folder wt-viewjobfolder"></i>Type: Per Hour</span></li>
															<li><span><i class="far fa-clock wt-viewjobclock"></i>Duration: 03 Months</span></li>
															<li><span><i class="fa fa-tag wt-viewjobtag"></i>Job ID: gy3yV2Vm5u</span></li>
															<li><a href="javascript:void(0);" class="wt-clicklike"><i class="fa fa-heart"></i> Click to Save</a></li>
											...
											<div class="wt-userlistinghold wt-userlistingholdvtwo">
												<div class="wt-userlistingcontent">
													...
													<div class="wt-viewjobholder">
														<ul>
															<li><span><i class="fa fa-dollar-sign wt-viewjobdollar"></i>Professional</span></li>
															<li><span><em><img src="{{ asset('web/images/flag/img-01.png') }}" alt="img description"></em>United Emirates</span></li>
															<li><span><i class="far fa-folder wt-viewjobfolder"></i>Type: Per Hour</span></li>
															<li><span><i class="far fa-clock wt-viewjobclock"></i>Duration: 03 Months</span></li>
															<li><span><i class="fa fa-tag wt-viewjobtag"></i>Job ID: gy3yV2Vm5u</span></li>
															<li><a href="javascript:void(0);" class="wt-clicklike"><i class="fa fa-heart"></i> Click to Save</a></li>
												...
												<div class="wt-userlistingcontent">
													...
													<div class="wt-viewjobholder">
														<ul>
															...
															<li><span><em><img src="{{ asset('web/images/flag/img-03.png') }}" alt="img description"></em>Canada</span></li>
															<li><span><i class="far fa-folder wt-viewjobfolder"></i>Type: Per Fixed</span></li>
															<li><span><i class="far fa-clock wt-viewjobclock"></i>Duration: 15 Days</span></li>
