...
<head>
	...
	<title>AHS LABEL</title>
	<meta name="description" content="">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<link rel="apple-touch-icon" href="{{ asset('web/images/logo/logo_small.png')}}">
	<link rel="icon" href="{{ asset('web/images/logo/logo_small.png')}}" type="image/x-icon">
